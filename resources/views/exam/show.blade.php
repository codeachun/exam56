...
->control(bs()->submit('儲存')) ->showAsRow() }} {{ bs()->closeForm() }} @endcan @if(Auth::id()) @can('進行測驗') {{ bs()->openForm('post',
'/test') }} @endif
<dl>
...
@can('進行測驗') {{ bs()->hidden('exam_id', $exam->id) }} {{ bs()->hidden('user_id', Auth::id()) }}
<div class="text-center my-5">
    {{ bs()->submit('寫完送出') }}
</div>

{{ bs()->closeForm() }} @endif @endif
